...
// ↕️
// function statByPlayer(stat) {
//     var result = []
//     const playerKeys = Object.keys(getPlayers())
//     switch(stat) {
//         case "number": 
//             var playerValues = Object.values(getPlayers()).map( player => player.number )
//             break
//         case "shoe": 
//             var playerValues = Object.values(getPlayers()).map( player => player.shoe )
//             break
//         case "points": 
//             var playerValues = Object.values(getPlayers()).map( player => player.points )
//             break
//         case "rebounds": 
//             var playerValues = Object.values(getPlayers()).map( player => player.rebounds )
//             break
//         case "assists": 
//             var playerValues = Object.values(getPlayers()).map( player => player.assists )
//             break
//         case "steals": 
//             var playerValues = Object.values(getPlayers()).map( player => player.steals )
//             break
//         case "blocks": 
//             var playerValues = Object.values(getPlayers()).map( player => player.blocks )
//             break
//         // case "slamDunks":
//         default:    
//             var playerValues = Object.values(getPlayers()).map( player => player.slamDunks )
//     }
//     for(i=0; i<playerKeys.length; i++) {
//         var obj = {}
//         var val = playerValues[i]
//         obj[playerKeys[i]] = val
//         result.push(obj)
//     }
//     return result
// }
...
//     const count = getPlayersStats().length
//     let bigShoePlayer = {}
//     for (let i = 0; i < count; i++) {
//         if (getPlayersStats()[i].shoe >= largestShoeSize) {
//             largeShoeSize = getPlayersStats()[i].shoe
//             bigShoePlayer = getPlayersStats()[i]
//         }
//     }
...
// function bigShoeRebounds() {
//     let largestShoeSize = 0
//     const count = Object.values(getPlayers()).length
//     let bigShoePlayer = {}
//     for (let i = 0; i < count; i++) {
//         if (Object.values(getPlayers())[i].shoe >= largestShoeSize) {
//             largeShoeSize = Object.values(getPlayers())[i].shoe
//             bigShoePlayer = Object.values(getPlayers())[i]
//         }
//     }
//     return bigShoePlayer.rebounds
// }
